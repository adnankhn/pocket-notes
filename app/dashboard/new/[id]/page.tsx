...
async function generateArticleSummary(data: string): Promise<string> {
  ...
  try {
    ...
    if (data?.description) {
      ...
      const prompt = `write a short but detailed summary capturing the key takeaways and present it with headings, subheading, bullet points, etc. of this article and return it in markdown format: ${data?.jsonData.content}`
